...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { latitude: @point.latitude, location: @point.location, longitude: @point.longitude }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { latitude: @point.latitude, location: @point.location, longitude: @point.longitude }
    assert_redirected_to point_path(assigns(:point))
  end
